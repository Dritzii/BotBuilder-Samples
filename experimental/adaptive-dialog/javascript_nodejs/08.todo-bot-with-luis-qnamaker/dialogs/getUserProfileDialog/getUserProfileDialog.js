...
const { OnBeginDialog, QnAMakerRecognizer, CrossTrainedRecognizerSet, DeleteProperty, TextInput, CodeAction, BreakLoop, EmitEvent, SetProperty, OnChooseIntent, OnQnAMatch, CancelAllDialogs, ActivityTemplate, ConfirmInput, IfCondition, ForEach, OnConversationUpdateActivity, LuisAdaptiveRecognizer, BeginDialog, OnIntent, AdaptiveDialog, SendActivity, TemplateEngineLanguageGenerator } = require('botbuilder-dialogs-adaptive');
